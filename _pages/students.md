...
<div class="student-block">
  ...
  <div class="info">
    ...
    <ul>
      <li><br>Research Interests: {{ student.research_interests }}</li> 
      <li><br>Email: <a href="mailto:{{ student.email }}">{{ student.email }}</a></li> 
    </ul>
  </div>
</div>
{% endfor %}
...
<div class="student-block">
  ...
  <div class="info">
    ...
    <ul> 
      <li><br>Research Interests: {{ student.research_interests }}</li>  
      <li><br>Research Title: "{{ student.research_title }}"</li>
      <li><br>Email: <a href="mailto:{{ student.email }}">{{ student.email }}</a></li>
    </ul>
  </div>
</div>
