...
|------|------------|-------------------------------------------------------------------------|---------------------------------------------|
| Part 1. Introduction {: colspan="4" .section-header} |
...
| Part 2. Randomized Experiments {: colspan="4" .section-header} |
...
| Part 3. Observational Studies with Measured Confounding {: colspan="4" .section-header} |
...
| Part 4. Observational Studies with Unmeasured Confounding {: colspan="4" .section-header} |
...
| Part 5. Sensitivity Analysis {: colspan="4" .section-header} |
...
| Part 6. Causal Directed Acyclic Graphs (DAGs) {: colspan="4" .section-header} |
...
| Part 7. Causal Mediation Analysis {: colspan="4" .section-header} |
...
| Part 8. Causal Inference for Longitudinal Data {: colspan="4" .section-header}  |
